...
public class Scanner {
    ...
    static {
        ...
        literals.put("library", 4);
        literals.put("ieee", 5);
        literals.put("use", 7);
        literals.put("entity", 9);
        literals.put("is", 10);
        literals.put("port", 11);
        literals.put("end", 14);
        literals.put("in", 16);
        literals.put("out", 17);
        literals.put("std_ulogic", 18);
        literals.put("std_ulogic_vector", 19);
        literals.put("downto", 20);
        literals.put("architecture", 21);
        literals.put("of", 22);
        literals.put("begin", 23);
        literals.put("component", 24);
        literals.put("signal", 25);
        literals.put("xor", 27);
        literals.put("and", 28);
        literals.put("or", 29);
        literals.put("nand", 30);
        literals.put("nor", 31);
        literals.put("xnor", 32);
        literals.put("not", 34);
        literals.put("map", 36);
        literals.put("open", 39);
    ...
    Token NextToken() {
        ...
        loop: for (;;) {
            switch (state) {
                ...
                {t.kind = 6; break loop;}
                case 5:
                    if (ch == 's') {AddCh(); state = 6; break;}
                    else {state = 0; break;}
                case 6:
                    if (ch == 't') {AddCh(); state = 7; break;}
                    else {state = 0; break;}
                case 7:
                    if (ch == 'd') {AddCh(); state = 8; break;}
                    else {state = 0; break;}
                case 8:
                    if (ch == '_') {AddCh(); state = 9; break;}
                    else {state = 0; break;}
                case 9:
                    if (ch == 'l') {AddCh(); state = 10; break;}
                    else {state = 0; break;}
                case 10:
                    if (ch == 'o') {AddCh(); state = 11; break;}
                    else {state = 0; break;}
                case 11:
                    if (ch == 'g') {AddCh(); state = 12; break;}
                    else {state = 0; break;}
                case 12:
                    if (ch == 'i') {AddCh(); state = 13; break;}
                    else {state = 0; break;}
                case 13:
                    if (ch == 'c') {AddCh(); state = 14; break;}
                    else {state = 0; break;}
                case 14:
                    if (ch == '_') {AddCh(); state = 15; break;}
                    else {state = 0; break;}
                case 15:
                    if (ch == '1') {AddCh(); state = 16; break;}
                    else {state = 0; break;}
                case 16:
                    if (ch == '1') {AddCh(); state = 17; break;}
                    else {state = 0; break;}
                case 17:
                    if (ch == '6') {AddCh(); state = 18; break;}
                    else {state = 0; break;}
                case 18:
                    if (ch == '4') {AddCh(); state = 19; break;}
                    else {state = 0; break;}
                case 19:
                    if (ch == '.') {AddCh(); state = 20; break;}
                    else {state = 0; break;}
                case 20:
                    if (ch == 'a') {AddCh(); state = 21; break;}
                    else {state = 0; break;}
                case 21:
                    if (ch == 'l') {AddCh(); state = 22; break;}
                    else {state = 0; break;}
                case 22:
                ...
                case 34:
                    recEnd = pos; recKind = 1;
                    if (ch >= '0' && ch <= '9' || ch == '_' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); state = 1; break;}
